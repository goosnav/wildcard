...
- **Corpus size:** 52 / ≥200 prompts (`eval/corpus.jsonl`), covering calculators, timers, generators, trackers, notes, lists, utility, converters, and live-data lookups — now including multi-feature, stateful, and edge-case prompts that exercise the repair loop. Doc 06 §6.2 calls for ≥200; see ROADMAP.md for the growth plan.
